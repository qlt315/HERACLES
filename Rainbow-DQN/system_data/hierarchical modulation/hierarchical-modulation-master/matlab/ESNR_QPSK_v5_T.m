...
b_16QAM = 0:(N_1-1); 
s_16QAM = qammod( b_16QAM, N_1) ;
qamdemod(s_16QAM, N_1); 
...
d_QPSK_QPSK = qamdemod( s_QPSK_QPSK, 16);
...
S_QPSK = ones( MAX_RUNS, 1 )  * qammod( 0:3, 4) ;
...
for m = 1 : length( SNR_dB )
    ...
    for n = 1 : length( Zeta )
        ...
        for k = 1 : length( theta )
            ...
            b0 = randi( RUNS, 1, 4 ) ;    s0 = qammod( b0, 4) ;
            b1 = randi( RUNS, 1, 4 ) ;    s1 = qammod( b1, 4) * zeta ;
