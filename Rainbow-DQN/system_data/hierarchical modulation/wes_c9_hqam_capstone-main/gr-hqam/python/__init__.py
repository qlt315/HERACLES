...
'''
This is the GNU Radio HQAM module. Place your Python package
...
# import swig generated symbols into the hqam namespace
try:
    # this might fail if the module is python-only
    from .hqam_swig import *
except module_not_found_error:
    pass

# import any pure python here
from .split_py_ff import split_py_ff
#
