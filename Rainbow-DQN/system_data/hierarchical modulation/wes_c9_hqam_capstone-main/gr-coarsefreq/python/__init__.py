...
'''
This is the GNU Radio COARSEFREQ module. Place your Python package
...
# import swig generated symbols into the coarsefreq namespace
try:
    # this might fail if the module is python-only
    from .coarsefreq_swig import *
