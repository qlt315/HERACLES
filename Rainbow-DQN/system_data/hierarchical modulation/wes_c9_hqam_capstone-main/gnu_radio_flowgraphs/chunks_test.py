...
class chunks_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "chunks_test")
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_b((0,1,3,0,2,1,1,3,3,1,2,3,3,1,1,1,2,2,1,1,0,3,0,0,2,2,3,3,1,0), True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0,1,1,2,2,1,3,0,3,1,1,1,2,2,3,0,0,0,1,1,1,1,2,2,3,3,2,2,1,3), True, 1, [])
        ...
        self.blocks_stream_to_tagged_stream_0_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 512, "hp_packet_len")
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 512, "lp_packet_len")
        self.blocks_stream_mux_0_0 = blocks.stream_mux(gr.sizeof_char*1, [30, 482])
        self.blocks_stream_mux_0 = blocks.stream_mux(gr.sizeof_char*1, [30, 482])
        ...
        self.connect((self.blocks_stream_mux_0, 0), (self.digital_chunks_to_symbols_xx_0_0, 0))
        self.connect((self.blocks_stream_mux_0_0, 0), (self.digital_chunks_to_symbols_xx_0_0_0, 0))
        ...
        self.connect((self.checkevm_getevm_0, 1), (self.blocks_stream_to_tagged_stream_0_0, 0))
        self.connect((self.checkevm_getevm_0, 0), (self.blocks_stream_to_tagged_stream_0_0_0, 0))
...
def main(top_block_cls=chunks_test, options=None):
