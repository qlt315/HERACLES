...
def run_all(seed):
    ...
    rainbow_sse_diff_est_err_matrix = np.zeros([7, len(est_err_list)],dtype=object)
    rainbow_tem_diff_est_err_matrix = np.zeros([7, len(est_err_list)],dtype=object)
    amac_diff_est_err_matrix = np.zeros([7, len(est_err_list)],dtype=object)
    dqn_diff_est_err_matrix = np.zeros([7, len(est_err_list)],dtype=object)
        ...
        for env_id in range(env_num):
            ...
            for e in range(len(est_err_list)):
                ...
                if algorithm == "rainbow_dqn" and env_id == 0:
                    ...
                    rainbow_tem_diff_est_err_matrix[6, e] = runner.env.episode_acc_vio_list
                elif algorithm == "dqn":
                    ...
                    dqn_diff_est_err_matrix[6, e] = runner.env.episode_acc_vio_list
    ...
    for e in range(len(est_err_list)):
        ...
        amac_diff_est_err_matrix[2, e] = runner.total_acc_list
        amac_diff_est_err_matrix[3, e] = runner.acc_vio_num
        amac_diff_est_err_matrix[4, e] = runner.re_trans_num
