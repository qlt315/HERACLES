...
from envs.env_tem_v2 import EnvTEM
...
if __name__ == '__main__':
    ...
    for k in range(len(seed_list)):
        ...
        if runner.env.name == "proposed":
            mat_name = "rainbow_dqn_lizhi/train_data/train_proposed_data.mat"
        elif runner.env.name == "sse":
            mat_name = "rainbow_dqn_lizhi/train_data/train_sse_data.mat"
        elif runner.env.name == "tem":
            mat_name = "rainbow_dqn_lizhi/train_data/train_tem_data.mat"

        print("Env Name:", mat_name)
        savemat(mat_name,
                {"rainbow_dqn" + runner.env.name + "_train_episode_total_delay": runner.env.episode_total_delay_list,
                 "rainbow_dqn" + runner.env.name + "_train_episode_total_energy": runner.env.episode_total_energy_list,
                 "rainbow_dqn" + runner.env.name + "_train_episode_reward": runner.env.episode_reward_list,
        ...
        # save the model
        if runner.env.name == "proposed":
            torch.save(runner.agent.net, 'rainbow_dqn_lizhi/models/rainbow_dqn_proposed.pth')
            torch.save(runner.agent.target_net, 'rainbow_dqn_lizhi/models/rainbow_dqn_target_proposed.pth')
        elif runner.env.name == "sse":
            torch.save(runner.agent.net, 'rainbow_dqn_lizhi/models/rainbow_dqn_sse.pth')
            torch.save(runner.agent.target_net, 'rainbow_dqn_lizhi/models/rainbow_dqn_target_sse.pth')
        elif runner.env.name == "tem":
            torch.save(runner.agent.net, 'rainbow_dqn_lizhi/models/rainbow_dqn_tem.pth')
            torch.save(runner.agent.target_net, 'rainbow_dqn_lizhi/models/rainbow_dqn_target_tem.pth')
    ...
    if runner.env.name == "proposed":
        reward_mat_name = "rainbow_dqn_lizhi/train_data/train_proposed_step_reward_matrix.mat"
        matrix_name = "rainbow_dqn_train_proposed_step_reward_matrix"
    elif runner.env.name == "sse":
        reward_mat_name = "rainbow_dqn_lizhi/train_data/train_sse_step_reward_matrix.mat"
        matrix_name = "rainbow_dqn_train_sse_step_reward_matrix"
    elif runner.env.name == "tem":
        reward_mat_name = "rainbow_dqn_lizhi/train_data/train_tem_step_reward_matrix.mat"
